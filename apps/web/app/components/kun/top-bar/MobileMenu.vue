...
const adminItems = computed(() =>
  userStore.isAdmin ? kunMobileAdminItem : []
)
...
<template>
  ...
  >
    ...
    <div
      v-if="props.isOpen"
      class="bg-background/95 fixed inset-x-0 top-16 bottom-0 z-30 h-[calc(100dvh-4rem)] overflow-y-auto backdrop-blur md:hidden"
  ...
  <!-- Login modal lives at the menu's root so closing the menu doesn't
