![kun-galgame-patch](./apps/web/public/kungalgame-trans.webp)
...
[https://github.com/KunMoe/kun-galgame-patch](https://github.com/KunMoe/kun-galgame-patch)
...
| 服务 | 默认端口 | 职责 |
| --- | --- | --- |
| NextMoe·未萌 账号 (OAuth) | `9277` | 身份认证唯一数据源（Authorization Code + PKCE），生产域 `account.nextmoe.com` |
...
本网站目前遵循 [AGPL-3.0 开源协议](https://www.gnu.org/licenses/gpl-3.0.en.html), 完全开源于 [GitHub](https://github.com/KunMoe/kun-galgame-patch)
...
[https://github.com/KunMoe/kun-galgame-patch/issues/new](https://github.com/KunMoe/kun-galgame-patch/issues/new)
